...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BANDL.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BD", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S BANDL -X kill
screen -S BANDL ./BANDL
done
]])  
file:close() 
...
sudo_users = {SUDO,1566031059,1511411448,1033028167}   
...
if hash or SudoBot(msg) or DevBANDLW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBANDLW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBANDLW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBANDLW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBANDLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBANDLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBANDLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1511411448) then
var = true 
...
local BANDL_Msg = ''  
if msgs < 100 then 
BANDL_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BANDL_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BANDL_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BANDL_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BANDL_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BANDL_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BANDL_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BANDL_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BANDL_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BANDL_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BANDL_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BANDL_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BANDL_Msg = 'رب التفاعل'  
end 
return BANDL_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBANDL(msg,data) -- بداية العمل
if msg then
...
if DevBANDLW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,BANDL_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل✬ :' and DevBANDLW(msg) then  
...
if text == 'تعطيل التواصل✬ :' and DevBANDLW(msg) then  
...
if text == 'تفعيل البوت الخدمي✬ :' and DevBANDLW(msg) then  
...
if text == 'تعطيل البوت الخدمي✬ :' and DevBANDLW(msg) then  
...
if text == 'ضع كليشه ستارت✬ :' and DevBANDLW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'✬ :ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت✬ :' and DevBANDLW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'✬ :تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر✬ :' and DevBANDLW(msg) then 
...
if text == 'تحديث السورس✬ :' and DevBANDLW(msg) then 
os.execute('rm -rf BANDL.lua')
os.execute('wget https://raw.githubusercontent.com/BANDLDTEAM/BANDL/main/BANDL.lua')
send(msg.chat_id_, msg.id_,'✬ :تم تحديث السورس \n✬ :لديك اخر اصدار لسورس براند\n✬ :الاصدار » { 1.5v}')
dofile('BANDL.lua')  
end
if text == 'الاصدار✬ :' and DevBANDLW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✬ :اصدار سورس براند \n✬ :الاصدار »{ 1.5v}')
end
if text == 'قناه تحديثات البوت✬ :' and DevBANDLW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✬ :[تحديثات البوت](t.me/GXKXG) \n✬ :[قناه السورس](t.me/CXRCX)')
end
if text == "ضع اسم للبوت✬ :" and DevBANDLW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"✬ :ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات✬ :' and DevBANDLW(msg) then 
...
if text == 'المشتركين✬ :' and DevBANDLW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n✬ :المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات✬ :' and DevBANDLW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n✬ :الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين✬ :") and DevBANDLW(msg) then
...
if text == ("قائمه العام✬ :") and DevBANDLW(msg) then
...
if text == ("قائمه الكتم العام✬ :") and DevBANDLW(msg) then
...
if text=="اذاعه خاص✬ :" and msg.reply_to_message_id_ == 0 and DevBANDLW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✬ :ارسل الان اذاعتك؟ \n✬ :للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه✬ :" and msg.reply_to_message_id_ == 0 and DevBANDLW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✬ :ارسل الان اذاعتك؟ \n✬ :للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت✬ :" and msg.reply_to_message_id_ == 0 and DevBANDLW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✬ :ارسل الان اذاعتك؟ \n✬ :للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه✬ :" and msg.reply_to_message_id_ == 0  and DevBANDLW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✬ :ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص✬ :" and msg.reply_to_message_id_ == 0  and DevBANDLW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"✬ :ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه✬ :' and DevBANDLW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين✬ :" and DevBANDLW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات✬ :" and DevBANDLW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✬ : عدد الكروبات الان » { '..#group..' }'..BANDLk..''..BANDL..'\n✬ : الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevBANDLW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevBANDLW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBANDLW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBANDLW(msg) then
...
local BANDL1_Msg = database:get(bot_id.."BANDL1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BANDL1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if BANDL_Msg and not Special(msg) then  
local BANDL_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BANDL_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBANDLW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBANDLW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBANDLW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✬ :حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBANDLW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✬ :حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك✬ :" and DevBANDLW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "✬ :تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك✬ :$") and DevBANDLW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✬ :حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري✬ :" and DevBANDLW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري✬ :" and DevBANDLW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "✬ :تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري✬ :" and DevBANDLW(msg) then  
...
database:sadd(bot_id.."BANDL:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."BANDL:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_BANDL = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_BANDL then 
names_BANDL = database:smembers(bot_id.."BANDL:blocname"..msg.chat_id_) or ""
if names_BANDL and names_BANDL[1] then 
for i=1,#names_BANDL do 
if name_BANDL:match("(.*)("..names_BANDL[i]..")(.*)") then 
...
database:set(bot_id.."BANDL:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."BANDL:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."BANDL:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."BANDL:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."BANDL:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_BANDLa_new(BANDL1,BANDL2)
if BANDL2 and BANDL2.first_name_ then 
if BANDL2.first_name_:match("(.*)"..database:get(bot_id.."BANDL:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BANDL:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BANDL_nnn = database:get(bot_id.."BANDL:nump"..msg.chat_id_) or 5
local BANDL_nnn2 = database:get(bot_id.."BANDL:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BANDL_nnn2) == tonumber(BANDL_nnn) or tonumber(BANDL_nnn2) > tonumber(BANDL_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BANDL:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✬ :عزيزي >>["..BANDL2.username_.."](https://t.me/"..(BANDL2.username_ or "CXRCX")..")\n✬ :عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BANDL:teh"..msg.chat_id_).."} بجانب اسمك\n✬ :عدد المحاولات المتبقيه {"..(tonumber(BANDL_nnn) - tonumber(BANDL_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BANDLa_new)
end
end
...
local BANDLChengName = database:get(bot_id.."BANDL:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BANDLChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BANDLChengName..']')
database:del(bot_id.."BANDL:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BANDLChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."BANDL:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BANDLChengUserName = database:get(bot_id.."BANDL:Cheng:UserName"..data.id_)
if not data.username_ then 
if BANDLChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BANDLChengUserName..']')
database:del(bot_id.."BANDL:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BANDLChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BANDL:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BANDLChengPhoto = database:get(bot_id.."BANDL:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BANDLChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."BANDL:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BANDLChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."BANDL:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevBANDLW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevBANDLW(msg) then    
dofile('BANDL.lua')  
send(msg.chat_id_, msg.id_, '✬ :تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevBANDLW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBANDLW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevBANDLW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevBANDLW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBANDLW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBANDLW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBANDLW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBANDLW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevBANDLW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBANDLW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBANDLW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBANDLW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBANDLW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_BANDL(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BANDL, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BANDL, nil)
return false 
end
...
database:set(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"✬ :ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BANDL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BANDL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"✬ :تم منع الكلمه مع التحذير")  
database:del(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BANDL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BANDL1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BANDL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"✬ :ارسل الكلمه الان")  
database:set(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BANDL1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BANDL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BANDL1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BANDL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BANDL1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BANDL1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n✬ :قائمة المنع \n𓍹ⵧⵧⵧⵧⵧⵧᑅ ᐧ ᑀⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do  
local BANDL_Msg = database:get(bot_id.."BANDL1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BANDL_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevBANDLW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'✬ :تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBANDLW(msg) then
...
if text == 'تفعيل الاذاعه' and DevBANDLW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBANDLW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..BANDL_Msg[math.random(#BANDL_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBANDLW(msg) then 
...
if text == ("مسح ردود المطور") and DevBANDLW(msg) then 
...
if text == ("ردود المطور") and DevBANDLW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n✬ :قائمة ردود المطور \n𓍹ⵧⵧⵧⵧⵧⵧᑅ ᐧ ᑀⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBANDLW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevBANDLW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevBANDLW(msg) then   
...
if text == 'تعطيل المغادره' and DevBANDLW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✬ :العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BANDL')..') '
...
-- vardump(data) 
BANDLdx(msg.chat_id_, msg.id_, '✬ :ايدي المجموعة » ( '..msg.chat_id_..' )\n✬ :عدد الادمنيه » ( *'..data.administrator_count_..' )*\n✬ :عدد المحظورين » ( *'..data.kicked_count_..' )*\n✬ :عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevBANDLW(msg) then
...
zx = JSON.decode(zh)
t = "\n✬ :قائمه الزخرفه \nٴ ✬ :𓍹ⵧⵧⵧⵧⵧⵧᑅ ᐧ ᑀⵧⵧⵧⵧⵧⵧ𓍻✬ :○ٴ \n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  "..v.." \n"
end
send(msg.chat_id_, msg.id_, t..'ٴ ✬ :𓍹ⵧⵧⵧⵧⵧⵧᑅ ᐧ ᑀⵧⵧⵧⵧⵧⵧ𓍻✬ :○ٴ\n✬ :彡 .[𝘽??𝘼??𝘿 𝙏𝙀𝘼𝙈](t.me/CXRCX)➢ ')
end
...
BANDL = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BANDL)
...
--------------------------------------------------------------------------------------------------------------
SourceBANDL(data.message_,data)
...
------------------------------------------------------------------------
local BANDLAbot = database:get(bot_id.."BANDL1:Add:Filter:Rp2"..text..result.chat_id_)   
if BANDLAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"✬ :العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬ :["..BANDLAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local BANDL1_Msg = database:get(bot_id.."BANDL1:Add:Filter:Rp2"..text..result.chat_id_)   
if BANDL1_Msg then    
send(msg.chat_id_, msg.id_,"✬ :"..BANDL1_Msg)
